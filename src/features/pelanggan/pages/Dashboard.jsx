    ...
    <div className="min-h-screen bg-[#F3F5F9] font-[Inter]">
      ...
      <header className="bg-[#03112B] border-b border-white/10">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          {/* MENU */}
          <nav className="hidden md:flex items-center gap-10 text-white/70 text-sm uppercase">
      ...
      {/* ================= FOOTER ================= */}
      <footer className="bg-[#03112B] text-white mt-10">
