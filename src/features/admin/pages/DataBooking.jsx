        ...
        <main className="flex-1 min-w-0 flex flex-col">
          ...
          <div className="p-4 md:p-6 lg:p-8 space-y-6">
            ...
            <div className="hidden md:block bg-[#0b1f38] border border-white/10 rounded-2xl overflow-hidden">
              ...
              {/* Pagination Desktop */}
              <div className="flex justify-between items-center bg-[#0b1f38] border-t border-white/10 p-4">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg transition ${
                      currentPage === 1 ? "bg-gray-700 cursor-not-allowed" : "bg-blue-600 hover:bg-blue-700"
                    }`}
                  >
                    Previous
                  </button>
                  ...
                  {[...Array(totalPages)].map((_, index) => (
                    <button
                      ...
                      className={`px-3 py-2 rounded-lg transition ${
                        currentPage === index + 1 ? "bg-blue-600" : "bg-[#08182d] hover:bg-white/10"
                      }`}
                    >
                      {index + 1}
                    </button>
                  ...
                  <button
                    ...
                    onClick={() => setCurrentPage(currentPage + 1)}
                    className={`px-4 py-2 rounded-lg transition ${
                      currentPage === totalPages || totalPages === 0 ? "bg-gray-700 cursor-not-allowed" : "bg-blue-600 hover:bg-blue-700"
                    }`}
                  >
                    Next
                  </button>
              ...
              <div className="md:hidden flex justify-center items-center gap-2 mt-4">
                <button
                  ...
                  className={`px-3 py-2 rounded-lg ${
                    currentPage === 1 ? "bg-gray-700 cursor-not-allowed" : "bg-blue-600"
                  }`}
                >
                  Prev
                </button>
                ...
                <button
                  ...
                  onClick={() => setCurrentPage((prev) => prev + 1)}
                  className={`px-3 py-2 rounded-lg ${
                    currentPage === totalPages || totalPages === 0 ? "bg-gray-700 cursor-not-allowed" : "bg-blue-600"
                  }`}
                >
                  Next
                </button>
